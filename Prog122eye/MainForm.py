...
class MainForm(Form):
	...
	def InitializeComponent(self):
		...
		self._button1.Size = System.Drawing.Size(201, 107)
		...
		# listBox1
		# 
		self._listBox1.BackColor = System.Drawing.Color.FromArgb(255, 192, 255)
		self._listBox1.FormattingEnabled = True
		self._listBox1.Location = System.Drawing.Point(194, 12)
		self._listBox1.Name = "listBox1"
		self._listBox1.Size = System.Drawing.Size(249, 342)
		...
		self._button2.Location = System.Drawing.Point(219, 370)
		self._button2.Name = "button2"
		self._button2.Size = System.Drawing.Size(201, 107)
		...
		self._button3.Location = System.Drawing.Point(426, 370)
		self._button3.Name = "button3"
		self._button3.Size = System.Drawing.Size(201, 107)
		...
		self.ClientSize = System.Drawing.Size(641, 489)
		self.Controls.Add(self._button3)
		self.Controls.Add(self._button2)
		self.Controls.Add(self._listBox1)
		self.Controls.Add(self._button1)
		self.Name = "MainForm"
		self.Text = "Prog122eye"
	...
	def Button1Click(self, sender, e):
		...
		for num in range(-25, 25 + 1):
			if num >= 0:
				...
				this = abs(num)
				SirWilliamTheThird = this**0.333333333
				cr = -SirWilliamTheThird
				
			c = num**3
			cr = round(cr, 5)
			all = str(num) + "\t" + str(cr) + "\t\t" + str(c)
